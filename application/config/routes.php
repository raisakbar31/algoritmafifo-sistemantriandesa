...
$route['queue/create'] = 'queue/create';
...
$route['queue/view'] = 'queue/view';
$route['admin/manage_queue'] = 'admin/manage_queue';
$route['admin/update_queue_service'] = 'admin/update_queue_service';
